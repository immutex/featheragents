...
**GitHub**
- Search for a related GitHub issue. Link it in the task file under `## GitHub` (e.g., `Relates to #123`).

**Context7**
- Before writing the task file, use Context7 to look up docs for any library or framework you are planning to work with.

**Web search**
- For research-heavy decisions, use web search to validate your technical approach before writing it into the task file.
